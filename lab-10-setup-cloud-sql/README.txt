...
Click on Create
    Name: bucket-import-mysql-data-udemy-learning-gcp-setup
...
Click on customers-db-instance
Click on IMPORT
    Source: Browse to bucket-import-mysql-data-udemy-learning-gcp-setup and select sql-dump-lab-10.sql
    File FormatL SQL
    Destination:
